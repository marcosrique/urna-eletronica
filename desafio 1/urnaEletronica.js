function urnaEletronica() {
    ...
    let nomeDoCandidato1;
    let nomeDoCandidato2;
    let nomeDoCandidato3;

    console.log('Início do programa');

    nomeDoCandidato1 = prompt("Digite o nome do candidato 1:");
    nomeDoCandidato2 = prompt("Digite o nome do candidato 2:");
    nomeDoCandidato3 = prompt("Digite o nome do candidato 3:");
    ...
    console.log('Total de votos do candidato(a): ' + nomeDoCandidato1 + " = " + votosCandidato1 + ' voto(s) (' + (votosCandidato1 / totalVotos * 100) + '%)');
    console.log('Total de votos do candidat(a): ' + nomeDoCandidato2 + " = " + votosCandidato2 + ' voto(s) (' + (votosCandidato2 / totalVotos * 100) + '%)');
    console.log('Total de votos do candidato 3: ' + nomeDoCandidato3 + " = " + votosCandidato3 + ' voto(s) (' + (votosCandidato3 / totalVotos * 100) + '%)');
